...
from MoeMusicBot.modules.play import generate_cover
from MoeMusicBot.modules.play import arq
from MoeMusicBot.modules.play import cb_admin_check
from MoeMusicBot.modules.play import transcode
from MoeMusicBot.modules.play import convert_seconds
from MoeMusicBot.modules.play import time_to_seconds
from MoeMusicBot.modules.play import changeImageSize
from MoeMusicBot.config import BOT_NAME as bn
from MoeMusicBot.config import DURATION_LIMIT
from MoeMusicBot.config import UPDATES_CHANNEL as updateschannel
from MoeMusicBot.config import que
from MoeMusicBot.function.admins import admins as a
from MoeMusicBot.helpers.errors import DurationLimitError
from MoeMusicBot.helpers.decorators import errors
from MoeMusicBot.helpers.admins import get_administrators
from MoeMusicBot.helpers.channelmusic import get_chat_id
from MoeMusicBot.helpers.decorators import authorized_users_only
from MoeMusicBot.helpers.filters import command, other_filters
from MoeMusicBot.helpers.gets import get_file_name
from MoeMusicBot.services.callsmusic import callsmusic, queues
from MoeMusicBot.services.callsmusic.callsmusic import client as USER
from MoeMusicBot.services.converter.converter import convert
from MoeMusicBot.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @MoeMusicBot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
